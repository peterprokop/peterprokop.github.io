...
function addJoystick(){
  addJoystickToElement('joystickWrapper1')
  addJoystickToElement('joystickWrapper2')
}

function addJoystickToElement(elementlId){
   const options = {
        zone: document.getElementById(elementlId),
        size: 120,
        multitouch: true,
